...
if (! (result->model = dm_disk_loadparams(blk, 0))) { // foo 
 } 
...
if (! ((result->queue = disksim_ioqueue_loadparams(blk, device_printqueuestats, device_printcritstats, device_printidlestats, device_printintarrstats, device_printsizestats)))) { // foo 
 } 
...
(void*)DISKSIM_DISK_MODEL_depend,
(void*)DISKSIM_DISK_SCHEDULER_depend,
(void*)DISKSIM_DISK_MAX_QUEUE_LENGTH_depend,
(void*)DISKSIM_DISK_BULK_SECTOR_TRANSFER_TIME_depend,
(void*)DISKSIM_DISK_SEGMENT_SIZE__depend,
(void*)DISKSIM_DISK_NUMBER_OF_BUFFER_SEGMENTS_depend,
(void*)DISKSIM_DISK_PRINT_STATS_depend,
(void*)DISKSIM_DISK_PER_REQUEST_OVERHEAD_TIME_depend,
(void*)DISKSIM_DISK_TIME_SCALE_FOR_OVERHEADS_depend,
(void*)DISKSIM_DISK_HOLD_BUS_ENTIRE_READ_XFER_depend,
(void*)DISKSIM_DISK_HOLD_BUS_ENTIRE_WRITE_XFER_depend,
(void*)DISKSIM_DISK_ALLOW_ALMOST_READ_HITS_depend,
(void*)DISKSIM_DISK_ALLOW_SNEAKY_FULL_READ_HITS_depend,
(void*)DISKSIM_DISK_ALLOW_SNEAKY_PARTIAL_READ_HITS_depend,
(void*)DISKSIM_DISK_ALLOW_SNEAKY_INTERMEDIATE_READ_HITS_depend,
(void*)DISKSIM_DISK_ALLOW_READ_HITS_ON_WRITE_DATA_depend,
(void*)DISKSIM_DISK_ALLOW_WRITE_PREBUFFERING_depend,
(void*)DISKSIM_DISK_PRESEEKING_LEVEL_depend,
(void*)DISKSIM_DISK_NEVER_DISCONNECT_depend,
(void*)DISKSIM_DISK_AVG_SECTORS_PER_CYLINDER_depend,
(void*)DISKSIM_DISK_MAXIMUM_NUMBER_OF_WRITE_SEGMENTS_depend,
(void*)DISKSIM_DISK_USE_SEPARATE_WRITE_SEGMENT_depend,
(void*)DISKSIM_DISK_LOW__WATER_MARK_depend,
(void*)DISKSIM_DISK_HIGH__WATER_MARK_depend,
(void*)DISKSIM_DISK_SET_WATERMARK_BY_REQSIZE_depend,
(void*)DISKSIM_DISK_CALC_SECTOR_BY_SECTOR_depend,
(void*)DISKSIM_DISK_ENABLE_CACHING_IN_BUFFER_depend,
(void*)DISKSIM_DISK_BUFFER_CONTINUOUS_READ_depend,
(void*)DISKSIM_DISK_MINIMUM_READ_AHEAD__depend,
(void*)DISKSIM_DISK_MAXIMUM_READ_AHEAD__depend,
(void*)DISKSIM_DISK_READ_AHEAD_OVER_REQUESTED_depend,
(void*)DISKSIM_DISK_READ_AHEAD_ON_IDLE_HIT_depend,
(void*)DISKSIM_DISK_READ_ANY_FREE_BLOCKS_depend,
(void*)DISKSIM_DISK_FAST_WRITE_LEVEL_depend,
(void*)DISKSIM_DISK_COMBINE_SEQ_WRITES_depend,
(void*)DISKSIM_DISK_STOP_PREFETCH_IN_SECTOR_depend,
(void*)DISKSIM_DISK_DISCONNECT_WRITE_IF_SEEK_depend,
(void*)DISKSIM_DISK_WRITE_HIT_STOP_PREFETCH_depend,
(void*)DISKSIM_DISK_READ_DIRECTLY_TO_BUFFER_depend,
(void*)DISKSIM_DISK_IMMED_TRANSFER_PARTIAL_HIT_depend,
(void*)DISKSIM_DISK_READ_HIT_OVER_AFTER_READ_depend,
(void*)DISKSIM_DISK_READ_HIT_OVER_AFTER_WRITE_depend,
(void*)DISKSIM_DISK_READ_MISS_OVER_AFTER_READ_depend,
(void*)DISKSIM_DISK_READ_MISS_OVER_AFTER_WRITE_depend,
(void*)DISKSIM_DISK_WRITE_HIT_OVER_AFTER_READ_depend,
(void*)DISKSIM_DISK_WRITE_HIT_OVER_AFTER_WRITE_depend,
(void*)DISKSIM_DISK_WRITE_MISS_OVER_AFTER_READ_depend,
(void*)DISKSIM_DISK_WRITE_MISS_OVER_AFTER_WRITE_depend,
(void*)DISKSIM_DISK_READ_COMPLETION_OVERHEAD_depend,
(void*)DISKSIM_DISK_WRITE_COMPLETION_OVERHEAD_depend,
(void*)DISKSIM_DISK_DATA_PREPARATION_OVERHEAD_depend,
(void*)DISKSIM_DISK_FIRST_RESELECT_OVERHEAD_depend,
(void*)DISKSIM_DISK_OTHER_RESELECT_OVERHEAD_depend,
(void*)DISKSIM_DISK_READ_DISCONNECT_AFTERREAD_depend,
(void*)DISKSIM_DISK_READ_DISCONNECT_AFTERWRITE_depend,
(void*)DISKSIM_DISK_WRITE_DISCONNECT_OVERHEAD_depend,
(void*)DISKSIM_DISK_EXTRA_WRITE_DISCONNECT_depend,
(void*)DISKSIM_DISK_EXTRADISC_COMMAND_OVERHEAD_depend,
(void*)DISKSIM_DISK_EXTRADISC_DISCONNECT_OVERHEAD_depend,
(void*)DISKSIM_DISK_EXTRADISC_INTER_DISCONNECT_DELAY_depend,
(void*)DISKSIM_DISK_EXTRADISC_2ND_DISCONNECT_OVERHEAD_depend,
(void*)DISKSIM_DISK_EXTRADISC_SEEK_DELTA_depend,
(void*)DISKSIM_DISK_MINIMUM_SEEK_DELAY_depend,
(void*)DISKSIM_DISK_IMMEDIATE_BUFFER_READ_depend,
(void*)DISKSIM_DISK_IMMEDIATE_BUFFER_WRITE_depend
};
