...
if (! (result->queue = disksim_ioqueue_loadparams(blk, drv_printqueuestats, drv_printcritstats, drv_printidlestats, drv_printintarrstats, drv_printsizestats))) { // foo 
 } 
...
(void*)DISKSIM_IODRIVER_TYPE_depend,
(void*)DISKSIM_IODRIVER_CONSTANT_ACCESS_TIME_depend,
(void*)DISKSIM_IODRIVER_USE_QUEUEING_IN_SUBSYSTEM_depend,
(void*)DISKSIM_IODRIVER_SCHEDULER_depend
};
