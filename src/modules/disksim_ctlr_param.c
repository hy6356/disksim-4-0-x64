...
if (! (result->queue = disksim_ioqueue_loadparams(blk, disksim->ctlrinfo->ctl_printqueuestats, disksim->ctlrinfo->ctl_printcritstats, disksim->ctlrinfo->ctl_printidlestats, disksim->ctlrinfo->ctl_printintarrstats,disksim->ctlrinfo->ctl_printsizestats))) { // foo 
 } 
...
(void*)DISKSIM_CTLR_TYPE_depend,
(void*)DISKSIM_CTLR_SCALE_FOR_DELAYS_depend,
(void*)DISKSIM_CTLR_BULK_SECTOR_TRANSFER_TIME_depend,
(void*)DISKSIM_CTLR_MAXIMUM_QUEUE_LENGTH_depend,
(void*)DISKSIM_CTLR_PRINT_STATS_depend,
(void*)DISKSIM_CTLR_SCHEDULER_depend,
(void*)DISKSIM_CTLR_CACHE_depend,
(void*)DISKSIM_CTLR_MAX_PER_DISK_PENDING_COUNT_depend
};
