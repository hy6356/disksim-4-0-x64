...
//	   fprintf (outputfile, "Entered loop i - numlogorgs %d, loop_i= %d, time %f\n", numlogorgs, i, simtime);
       ...
       {
//	   fprintf (outputfile, "curr devno no mapping on logorgs arraydisk");
       }
     }
     else
     {
	 ...
	 if (curr->devno == logorgs[i]->devs[j].devno)
	 {
	   ...
	   {
	     logorgno = i;
//	     fprintf (outputfile, "Entered loop j - numlogorgs %d, loop_j= %d, i= %d, at time %f\n", numlogorgs, j, i, simtime);
	     break;
	   }
	   else
	   {
//	     fprintf (outputfile, "No logorg overlap");
	   }
	 }
	 else
	 {
             fprintf (outputfile, "curr devno no mapping on logorgs actualdisks");
	 }
       }
       if (logorgno != -1)
       {
